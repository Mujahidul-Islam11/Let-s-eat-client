...
const SectionBanner = ({url, title, pageName}) => {
    ...
    >
      <div className="w-full h-full bg-black bg-opacity-10 text-center flex flex-col justify-center items-center gap-4">
        ...
        <div className="flex gap-3">
            ...
            <h3 className="text-sm md:text-lg border-b border-yellow-300">{pageName}</h3>
        </div>
      </div>
    </div>
    );
