...
const AboutUs = () => {
  return (
    <div className="w-full h-[600px] my-12 flex justify-center items-center gap-14">
      <img
        className="w-[40%] h-[88%] object-cover"
        ...
        alt=""
      />
      <div className="relative w-[40%] h-[88%] bg-white p-8 rounded-md flex flex-col justify-center">
        <div className="absolute h-52 w-40 bg-gray-300 top-8 z-5 opacity-30 -left-1"></div>
        <div className="z-10">
