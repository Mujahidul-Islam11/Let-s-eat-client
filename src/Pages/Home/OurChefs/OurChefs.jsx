...
const OurChefs = () => {
  ...
  return (
    <section className="my-12">
      ...
      ></SectionTitle>
      <div className="flex flex-col md:flex-row justify-center gap-8 py-12 px-4">
        {chefs.map((chef) => (
          <div
            key={chef.id}
            className="bg-white shadow-lg rounded-lg px-3 pb-6 w-1/2 text-center space-y-3 border"
          >
